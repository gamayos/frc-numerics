...
// ---- 7. the observer variety and the light cone ----
{
  ok('the observer variety (00:C6): (p-1) p (p+1) = 12 x 13 x 14 = 2184 = '+
     '|SL2(F13)|, and at the Carrier scale (Om-1) Om (Om+1) = 232 x 233 x '+
  ...
  ok('the cone chart is the affine group: the Borel plane, 13 x 12 = 156 '+
     '= p(p - 1) cells, closing at lcm(12, 13) = 156; and |SL2| = 156 x '+
     '14: the Borel times the boosts',
