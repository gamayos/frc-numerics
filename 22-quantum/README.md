...
Expected output: one `PASS` line per check (89 in total), informational
...
**Totals: 11 suites, 89 checks, all passing.**
...
The companion technical notes are included as compiled PDFs; each suite's
