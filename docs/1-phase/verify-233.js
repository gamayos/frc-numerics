// Exact verification for 1-phase-4 on the minimal non-trivial pair (13, 233).
...
// by diff outside this script.
{
  ...
  ok('the page carries the episode marker (1-phase-4)',
     html.includes('data-episode="1-phase-4"'));
}
